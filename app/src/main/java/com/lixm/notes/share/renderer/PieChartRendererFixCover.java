package com.lixm.notes.share.renderer;
...
//                        pt2x = pt1x + polyline2Width;
                    ...
                    if (drawXOutside && drawYOutside) {
                        ...
                        drawValue(c, formattedValue, labelPtx, labelPty + lineHeight / 2.f, dataSet
                                .getValueTextColor(j));
                    }
                }
...
////                        pt2x = pt1x + polyline2Width;
                    ...
                    // draw everything, depending on settings
                    if (drawXOutside && drawYOutside) {
                        drawValue(c,entry.getValue()+"", labelPtx,
                                labelPty ,
                                dataSet.getValueTextColor(j));
                        ...
                        drawValue(c, entry.getValue()+"", labelPtx, labelPty + lineHeight / 2.f, dataSet
                                .getValueTextColor(j));
                    }
                }
                ...
                if (drawXInside || drawYInside) {
                    ...
                    if (drawXInside && drawYInside) {
                        ...
                        drawValue(c, entry.getValue()+"", x, y, dataSet.getValueTextColor(j));
                        ...
                        drawValue(c, entry.getValue()+"", x, y + lineHeight / 2f, dataSet.getValueTextColor(j));
                    }
                }

...
/**
 * 时   间:     2017/6/27 0027 11:43
 * 作   者:     zenghonghua
 */
public class MyPieChart extends PieRadarChartBase<PieData> {
    ...
    protected void init() {
        ...
        mHighlighter = new MyPieHighlighter(this);
    }
    ...
    public void setHoleColor(int color) {
        ((MyPieChartRenderer) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((MyPieChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((MyPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((MyPieChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((MyPieChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((MyPieChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((MyPieChartRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((MyPieChartRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((MyPieChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof MyPieChartRenderer) {
            ((MyPieChartRenderer) mRenderer).releaseBitmap();
        }
